...
describe Fastlane::Helper::SyncDevicesHelper::Command do
  describe Fastlane::Helper::SyncDevicesHelper::Command::Noop do
    let(:device) do
  ...
  describe Fastlane::Helper::SyncDevicesHelper::Command::Disable do
    let(:device) do
      Spaceship::ConnectAPI::Device.new(
        'ID',
        {
  ...
  describe Fastlane::Helper::SyncDevicesHelper::Command::Enable do
    let(:device) do
      Spaceship::ConnectAPI::Device.new(
        'ID',
        {
  ...
  describe Fastlane::Helper::SyncDevicesHelper::Command::Rename do
    let(:device) do
      Spaceship::ConnectAPI::Device.new(
        'ID',
        {
  ...
  describe Fastlane::Helper::SyncDevicesHelper::Command::DisableAndRename do
    let(:device) do
      Spaceship::ConnectAPI::Device.new(
        'ID',
        {
    ...
    describe '#run' do
      it 'disables and renames the device' do
        ...
        expect(Spaceship::ConnectAPI::Device).to have_received(:modify).with('UDID', enabled: false,
                                                                                     new_name: 'NEW_NAME').once
      end
    end
  ...
  describe Fastlane::Helper::SyncDevicesHelper::Command::EnableAndRename do
    let(:device) do
      Spaceship::ConnectAPI::Device.new(
        'ID',
        {
  ...
  describe Fastlane::Helper::SyncDevicesHelper::Command::Create do
    let(:device) do
      Spaceship::ConnectAPI::Device.new(
        'ID',
        {
    ...
    describe '#run' do
      it 'creates the device' do
        ...
        expect(Spaceship::ConnectAPI::Device).to have_received(:create)
          .with(name: 'NAME', platform: Spaceship::ConnectAPI::BundleIdPlatform::IOS, udid: 'UDID')
      end
    end
